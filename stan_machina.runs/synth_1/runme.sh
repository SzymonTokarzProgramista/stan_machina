...
HD_PWD='C:/Studia/Semestr_6/Systemy_Rekonfigurowalne/stan_machina/stan_machina.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log states.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source states.tcl
